...
function loadFromFile(filename) {
  ...
  return new cls(require(path.resolve(process.cwd(), filename)))
}
...
//
// Iterates over all atoms to be loaded, calling fn with two arguments: the type and the total configuration.
//
